...
export async function ingestFile(
  ...
  // Cloud delivery to other devices (Sent books included) is handled by
  // the file-sync engine for whichever third-party backends the user has
  // enabled — see services/sync/file/runLibrarySync.ts. There is no
  // Readest Cloud upload path anymore.
