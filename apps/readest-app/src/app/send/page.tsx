 ...
 * shared import pipeline directly (no inbox round-trip): drop a file or
 * paste an article URL and it lands in the local library, mirroring to any
 * third-party cloud sync backend the user has enabled.
 */
